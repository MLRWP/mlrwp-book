...
# Reserving with GLMs {#sec-glms-r}

*This [article](https://institute-and-faculty-of-actuaries.github.io/mlr-blog/post/foundations/r-glms/) was written by Grainne McGuire and originally published on 26 April 2021*

*A version of this article using Python rather than R is available [here](https://institute-and-faculty-of-actuaries.github.io/mlr-blog/post/foundations/python-glms/).*
*It was co-authored by Gabrielle Pittarello.*
...
library(DT) # formats tables nicely
...
The total reserve is `r ocl_total |> round(0) |> prettyNum(big.mark = ",")`.
